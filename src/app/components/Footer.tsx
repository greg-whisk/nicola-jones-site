    ...
    <footer className="relative bg-[#2B2726] text-[#FAF8F5] pt-20 pb-12 overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="font-['Manrope'] font-heading-manrope mb-4">Quick Links</h4>
          ...
          <div>
            <h4 className="font-['Manrope'] font-heading-manrope mb-4">Say Hello</h4>
          ...
          <div>
            <h4 className="font-['Manrope'] font-heading-manrope mb-4">Newsletter</h4>
