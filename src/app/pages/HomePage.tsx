...
const fallbackShopProducts: ShopProduct[] = [
  {
    ...
    description: "A bold, vibrant print bursting with Nicola's signature characterful illustrations. Printed on fine art paper, ready to frame.",
    price: 35,
    category: 'prints',
    accentColor: '#E8846F',
  },
  ...
  {
    slug: 'decorated-balls',
    image: '',
    title: 'Decorated Balls',
    price: 75,
    category: 'gifts',
    accentColor: '#5D9B9B',
  },
