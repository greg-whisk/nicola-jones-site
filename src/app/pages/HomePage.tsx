  ...
  return (
    <div className="overflow-hidden">
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                ...
                <div className="absolute top-6 left-6">
                  <span className="bg-[#E8846F] text-white px-4 py-2 rounded-full text-sm font-['Nunito']">Bestseller</span>
                </div>
              ...
              <div className="p-8 lg:p-12">
                ...
                <h3 className="font-['Fredoka'] text-3xl lg:text-4xl text-[#4A3428] mt-2 mb-4">{shopProducts[0].title}</h3>
                <p className="text-lg text-[#6B7554] leading-relaxed mb-6">{shopProducts[0].description}</p>
                <div className="flex items-center gap-6">
                  <span className="font-['Fredoka'] text-3xl" style={{ color: shopProducts[0].accentColor }}>£{shopProducts[0].price}</span>
              ...
              >
                <Link to={`/shop/${product.slug}`}>
                  <motion.div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group" whileHover={{ y: -6 }}>
                    ...
                    <div className="p-4">
                      <h4 className="font-['Fredoka'] text-sm text-[#4A3428] truncate">{product.title}</h4>
                      <p className="font-['Fredoka'] text-lg" style={{ color: product.accentColor }}>£{product.price}</p>
                    </div>
                  </motion.div>
                </Link>
              </motion.div>
      ...
      <section className="bg-[#F5EFE8] py-16 overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6">
          <motion.p
            className="font-['Fredoka'] text-lg text-[#6B7554] text-center mb-10"
            initial={{ opacity: 0 }}
          ...
          <div className="relative">
            ...
            >
              {[...clients, ...clients].map((client, i) => (
                <span
                  key={`${client}-${i}`}
                  className="flex-shrink-0 font-['Fredoka'] text-xl text-[#4A3428]/30 whitespace-nowrap hover:text-[#4A3428]/60 transition-colors"
                >
                  {client}
                </span>
              ))}
      ...
      <section className="py-20 relative">
        ...
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <p className="text-[#5D9B9B] font-['Fredoka'] text-lg mb-3 uppercase tracking-wider">About Nicola</p>
              <h2 className="font-['Fredoka'] text-4xl lg:text-5xl text-[#4A3428] mb-6 leading-[1.15]">
      ...
      <section className="bg-[#F5EFE8] py-24 relative overflow-hidden">
        ...
        <div className="max-w-[900px] mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <h2 className="font-['Fredoka'] text-4xl lg:text-6xl text-[#4A3428] mb-6 leading-[1.15]">
