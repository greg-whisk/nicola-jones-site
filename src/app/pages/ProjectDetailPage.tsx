  ...
  if (!project) {
    return (
      <div className="py-40 text-center">
        <h1 className="font-['Fredoka'] text-5xl text-[#4A3428] mb-4">Project not found</h1>
    ...
    <div className="overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 pt-8 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h1 className="font-['Fredoka'] text-5xl lg:text-6xl text-[#4A3428] mb-6 leading-[1.1]">
                {project.title}
              </h1>
          ...
          <div className="max-w-[1440px] mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {project.stats.map((stat, i) => (
                ...
                >
                  <div className="font-['Fredoka'] text-3xl lg:text-4xl text-[#4A3428] mb-1">
                    {stat.value}
                  </div>
            ...
            >
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: project.accentColor }}>
                      <span className="font-['Fredoka'] text-sm">01</span>
                    </div>
                    <h2 className="font-['Fredoka'] text-3xl text-[#4A3428]">The Brief</h2>
                  </div>
              ...
              {project.approach && (
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: project.accentColor }}>
                      <span className="font-['Fredoka'] text-sm">02</span>
                    </div>
                    <h2 className="font-['Fredoka'] text-3xl text-[#4A3428]">The Approach</h2>
                  </div>
                  <p className="text-lg text-[#6B7554] leading-relaxed pl-[52px]">
                    {project.approach}
                  </p>
              ...
              {project.outcome && (
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: project.accentColor }}>
                      <span className="font-['Fredoka'] text-sm">03</span>
                    </div>
                    <h2 className="font-['Fredoka'] text-3xl text-[#4A3428]">The Outcome</h2>
                  </div>
                  <p className="text-lg text-[#6B7554] leading-relaxed pl-[52px]">
                    {project.outcome}
                  </p>
      ...
      {project.testimonial && (
        <section className="py-20 relative">
          ...
          <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
            ...
            <blockquote className="font-['Fredoka'] text-2xl lg:text-3xl text-[#4A3428] mb-6 leading-relaxed">
              "{project.testimonial.quote}"
            </blockquote>

            <div className="text-[#6B7554]">
              <span className="font-['Fredoka'] text-lg">{project.testimonial.author}</span>
              <br />
      ...
      <section className="py-16">
        <div className="max-w-[1440px] mx-auto px-6 text-center">
          <h2 className="font-['Fredoka'] text-3xl text-[#4A3428] mb-4">
            Like what you see?
          </h2>
